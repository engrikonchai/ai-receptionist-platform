...
/**
 * The one place every agent-settings query and action funnels through
 * before touching `businesses` or `agent_settings`. Re-loads the
 ...
 * supplied it. Fails closed on no business or more than one business
 * (see loadOwnerContext()'s own `multiple_businesses` case), and every
